...
macro_rules! all_commands {
    () => {
        tauri::generate_handler![
            ...
            commands::finance_health,
            commands::finance_overview_snapshot,
            commands::finance_orders_snapshot,
            commands::finance_symbol_snapshot,
            commands::finance_get_watchlist,
            commands::finance_update_watchlist,
            commands::finance_search_news,
            commands::finance_query_data,
            commands::finance_screen_stocks,
            commands::finance_batch_check,
            commands::finance_prepare_order,
            commands::finance_place_order,
            ...
            commands::kb_search,
            commands::kb_get_settings,
            commands::kb_save_settings,
